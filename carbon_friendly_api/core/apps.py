...
class CoreConfig(AppConfig):
    ...
    DATASETS = (
        {"file_name": CO2_FILENAME, "label": "CO2", "method": "carbon_dioxide",
            "name": "Carbon Dioxide", "source": "NOAA", "unit": "PPM", "url": CO2_URL, "field": "trend", },
        {"file_name": CH4_FILENAME, "label": "CH4", "method": "methane", "name": "Methane",
            "source": "NOAA", "unit": "PPM", "url": CH4_URL, "field": "average", },
        {"file_name": N2O_FILENAME, "label": "N2O", "method": "nitrous_oxide", "name": "Nitrous Oxide",
            "source": "NOAA", "unit": "PPB", "url": N2O_URL, "field": "average", },
        {"file_name": TEMPERATURE_CHANGE_FILENAME, "label": None, "method": "temperature_change",
            "name": "Temperature Change", "source": "NOAA", "unit": "C", "url": TEMPERATURE_CHANGE_URL, "field": "station", },
    )
